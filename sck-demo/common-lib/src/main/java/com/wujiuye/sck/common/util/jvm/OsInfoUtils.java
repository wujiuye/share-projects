...
class OsInfoUtils {
    ...
    public static MachineInfo.MemoryInfo printMemoryInfo(SystemInfo systemInfo) {
        ...
        memoryInfo.setMaxCapacit(UnitConversionUtils.formatByte(mem.getTotal()));
        memoryInfo.setCurrentUse(UnitConversionUtils.formatByte(mem.getTotal() - mem.getAvailable()));
    ...
    public static List<MachineInfo.DiskInfo> printDiskUsage(SystemInfo systemInfo) {
        ...
        for (OSFileStore fs : fsArray) {
            ...
            diskInfo.setFree(UnitConversionUtils.formatByte(free));
            diskInfo.setUsed(UnitConversionUtils.formatByte(used));
            diskInfo.setTotal(UnitConversionUtils.formatByte(total));
